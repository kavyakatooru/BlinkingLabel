...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/kavya/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'kavya' => 'katoorukavya@gmail.com' }
  s.source           = { :git => 'https://github.com/kavya/BlinkingLabel.git', :tag => s.version.to_s }
